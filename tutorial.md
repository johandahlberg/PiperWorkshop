...
==================================
s document contains a small tutorial for the Piper workshop on [insert date]. The idea is to have a small workshop about Queue/Piper, going through the basics of how Queue/Pipere works and getting some hands on experience in writing QScripts.
...
Troubleshootings document contains a small tutorial for the Piper workshop on [insert date]. The idea is to have a small workshop about Queue/Piper, going through the basics of how Queue/Pipere works and getting some hands on experience in writing QScripts.
...
* Possible to create reusable components
* Excellent support for the GATK suite
* Relatively simple to add new components to a pipline
